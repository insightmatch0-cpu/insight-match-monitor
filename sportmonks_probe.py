...
def main():
    ...
    if not KEY:
        ...
        # 1) كل الدوريات المشمولة بالاشتراك — السؤال الحاسم: أين دوري روشن؟
        ...
        # 3) مباريات منتهية حديثاً مع xG — آخر يومين
        for back in (1, 2):
        ...
        # 4) عينة تحقق تاريخية: آخر جولة من الدوري الإنجليزي الماضي (2026-05-24)
        #    مع xG — مرجع مقارنة Opta المطلوب في الخطة
        out["epl_last_round_xg"] = call(
            "fixtures/date/2026-05-24",
            {"per_page": 10, "include": "xgfixture",
             "filters": "fixtureLeagues:8"})
        # 5) شكل إحصائيات مباراة منتهية (للطبقة الحية لاحقاً — HT/FT فقط)
